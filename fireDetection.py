...
def send_mail_function(): # defined function to send mail post fire detection using threading
    ...
    try:
        ...
        server.ehlo()
        server.starttls()
        server.login("vrupa2000@gmail.com", 'yogi@789') # Senders mail ID and password
        server.sendmail('vrupa2000@gmail.com','vrupa2000@gmail.com', "Warning fire accident has been reported") # recipients mail with mail message
        print("Alert mail sent sucesfully to {}".format('vrupa2000@gmail.com')) # to print in consol to whome mail is sent
